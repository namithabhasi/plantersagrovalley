        ...
        <div className="planters-page-wrapper text-[#1c2c21]">
            ...
            <section className="planters-header-section pt-16 pb-12">
                <div className="container">
                    ...
                    <p className="planters-page-description font-[var(--font-family-base)] text-xs sm:text-sm text-[#4b5563] max-w-[800px] leading-relaxed">
                    ...
                    <div className="planters-mobile-cat-dropdown-wrap mt-4 mb-5 sm:hidden">
            ...
            <section className="planters-catalog-section py-6 sm:py-12">
                <div className="container planters-layout-container">

                    {/* Left Column: Sidebar Filters */}
                    <div className="planters-sidebar planters-sidebar-desktop">
